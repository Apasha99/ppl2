...
<section>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a id="downloadLink" class="btn btn-primary" href="#" download="list_skripsi.pdf">Unduh PDF</a>
    ...
    <script>
        ...
        function openPDFModal() {
            const pdfUrl = "{{ route('generateListSkripsiLulus',['angkatan' => $mahasiswa->angkatan, 'status' => 'verified']) }}";
            const pdfUrl2 = "{{ route('PreviewListSkripsiLulus',['angkatan' => $mahasiswa->angkatan, 'status' => 'verified']) }}";
        ...
        document.getElementById('downloadLink').addEventListener('click', function(event) {
            ...
            .then(blob => {
                ...
                a.href = url;
                a.download = 'list_lulus_skripsi.pdf';
