...
@section('content')
    <div class="container-lg my-5 text-light">
        ...
        <div class="d-flex justify-content-end my-4">
            <a href="{{ route('pkl.create') }}" class="btn btn-primary btn-sm">+ Tambah PKL</a>
        </div>
        ...
        <div class="d-flex justify-content-start">
                ...
                <div class="dropdown id">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownSemester">
                        @foreach ($pklData as $pkl)
                            <li class="dropdown-item" data-semester="{{ $pkl->semester_aktif }}">{{ $pkl->semester_aktif }}
                            </li>
                        @endforeach
                    </ul>
                </div>

                <div id="pklDetail" class="ms-3" style="display: none;">
            ...
            @else
                <div class="d-flex justify-content-center">
                    <p class="lead">
                        <span class="text-danger"><i class="bi bi-exclamation-circle-fill"></i></span> Belum ada PKL yang
                        diisi.
                    </p>
                </div>
            @endif
